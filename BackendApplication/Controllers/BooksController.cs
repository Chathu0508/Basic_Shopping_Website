...
namespace BackendApplication.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BookName,AuthorName,Description,Price,Image,GenreId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BookName,AuthorName,Description,Price,Image,GenreId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
